...
public class PortableMEChestGuiHandler implements IGuiHandler {
    ...
    public Object getServerGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
        ...
        if (id == GUI_BLOCK_OUTPUT_ACCESS) {
            net.minecraft.tileentity.TileEntity te = world.getTileEntity(x, y, z);
            if (te instanceof portablemechest.tile.TilePortableOutputChest) {
                portablemechest.tile.TilePortableOutputChest tile = (portablemechest.tile.TilePortableOutputChest) te;
                portablemechest.items.content.PortableOutputChestGuiObject obj = new portablemechest.items.content.PortableOutputChestGuiObject(
                    tile);
                return new appeng.container.implementations.ContainerMEPortableCell(player.inventory, obj);
            }
        }

        if (id == GUI_BLOCK_OUTPUT_CONFIG) {
            net.minecraft.tileentity.TileEntity te = world.getTileEntity(x, y, z);
            if (te instanceof portablemechest.tile.TilePortableOutputChest) {
                portablemechest.tile.TilePortableOutputChest tile = (portablemechest.tile.TilePortableOutputChest) te;
                return new portablemechest.container.ContainerPortableOutputChestCell(player.inventory, tile);
            }
        }
        return null;
    }
    ...
    public Object getClientGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
        ...
        if (id == GUI_BLOCK_OUTPUT_ACCESS) {
            ...
            if (te instanceof portablemechest.tile.TilePortableOutputChest) {
                ...
                portablemechest.items.content.PortableOutputChestGuiObject obj = new portablemechest.items.content.PortableOutputChestGuiObject(
                    tile);
                appeng.container.implementations.ContainerMEPortableCell container = new appeng.container.implementations.ContainerMEPortableCell(
                    player.inventory,
                    obj);
                return new GuiMEMonitorable(player.inventory, obj, (ContainerMEMonitorable) container);
            }
        ...
        if (id == GUI_BLOCK_OUTPUT_CONFIG) {
            ...
            if (te instanceof portablemechest.tile.TilePortableOutputChest) {
                portablemechest.tile.TilePortableOutputChest tile = (portablemechest.tile.TilePortableOutputChest) te;
                portablemechest.container.ContainerPortableOutputChestCell container = new portablemechest.container.ContainerPortableOutputChestCell(
                    player.inventory,
                    tile);
                return new portablemechest.client.gui.GuiPortableOutputChestCell(container, player);
            }
        }
        return null;
    }
