...
public class GuiPortableMEChestCell extends GuiContainer {

    private static final ResourceLocation TEXTURE = new ResourceLocation(
        "appliedenergistics2",
        "textures/guis/chest.png");
    private final ContainerPortableMEChestCell container;

    public GuiPortableMEChestCell(ContainerPortableMEChestCell container, EntityPlayer player) {
        super(container);
